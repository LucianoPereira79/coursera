    ...
    function buildAndShowHomeHTML(categories) {
        ...
        $ajaxUtils.sendGetRequest(
          ...
          function (homeHtml) {
              ...
              $ajaxUtils.sendGetRequest(categoryHtml, function (tempCatHtml) {
                  console.log("tempCatHtml:");
                  console.log(tempCatHtml);

                  homeHtmlToInsertIntoMainPage = insertProperty(tempCatHtml, "{{randomCategoryShortName}}", category.short_name);
